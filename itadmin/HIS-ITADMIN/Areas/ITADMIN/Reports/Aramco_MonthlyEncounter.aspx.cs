...
{
    public partial class Aramco_MonthlyEncounter : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                DataTable dt = DB.ExecuteSPAndReturnDataTable("dbo.SP_AramcoEncounterMonthly");
                rpt.LocalReport.ReportPath = "Areas/ITADMIN/Reports/Aramco_MonthlyEncounter.rdl";
                ...
                rpt.LocalReport.DisplayName = "SA01-" + MONTH + "_" + YEAR ;
