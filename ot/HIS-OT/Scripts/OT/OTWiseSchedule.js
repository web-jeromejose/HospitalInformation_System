...
function ShowListColumns() {
    ...
    { targets: [1], data: "ctr", className: '', visible: true, searchable: true, width: "2%" },
    { targets: [2], data: "fromdatetime", className: '', visible: true, searchable: true, width: "5%" },
    { targets: [3], data: "todatetime", className: '', visible: true, searchable: false, width: "5%" },
    { targets: [4], data: "Name", className: '', visible: true, searchable: true, width: "0%" },
    { targets: [5], data: "Age", className: '', visible: true, searchable: true, width: "3%" },
    { targets: [6], data: "BedNo", className: '', visible: true, searchable: true, width: "3%" },
    { targets: [7], data: "Ward", className: '', visible: true, searchable: true, width: "0%" },
    { targets: [8], data: "Surgery", className: '', visible: true, searchable: true, width: "15%" },
    { targets: [9], data: "Surgeon", className: '', visible: true, searchable: true, width: "15%" },
    { targets: [10], data: "Anaesthetist", className: '', visible: true, searchable: true, width: "15%" },
    { targets: [11], data: "Anaesthesia", className: '', visible: true, searchable: true, width: "15%" }
    ];
    return cols;
}
...
function ShowList(otid, dfrom, dto) {
    var Url = baseURL + "MainListOTWiseSchedule";
    var param = {
        otid: otid,
        dfrom: dfrom,
        dto: dto
