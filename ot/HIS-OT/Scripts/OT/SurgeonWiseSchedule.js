...
$(document).ready(function () {
    ...
    c.SetTitle("Surgeon Wise Schedule");
    c.DefaultSettings();
...
function InitSelect2() {
    $('#select2Surgeon').select2({
        ...
        ajax: {
            quietMillis: 150,
            url: baseURL + 'Select2ReportSurgeon',
            dataType: 'jsonp',
            cache: false,
...
function View(surgeonId, dfrom, dto) {
    Url = baseURL + "MainListSurgeonWiseSchedule";
    param = {
        surgeonId: surgeonId,
        dfrom: dfrom,
        dto: dto
...
function ShowListColumns() {
    ...
    { targets: [2], data: "OTNo", className: '', visible: true, searchable: true, width: "3%" },
    { targets: [3], data: "FromDateTime", className: '', visible: true, searchable: false, width: "5%" },
...
function ShowList(surgeonId, dfrom, dto) {
    var Url = baseURL + "MainListSurgeonWiseSchedule";
    var param = {
        surgeonId: surgeonId,
        dfrom: dfrom,
        dto: dto
