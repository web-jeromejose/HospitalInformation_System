...
function ShowListColumns() {
    ...
    { targets: [1], data: "ctr", className: '', visible: true, searchable: true, width: "1%" },
    { targets: [2], data: "CompanyName", className: '', visible: true, searchable: true, width: "6%" },
    { targets: [3], data: "Name", className: '', visible: true, searchable: false, width: "6%" },
    { targets: [4], data: "BedNo", className: '', visible: true, searchable: true, width: "2%" },
    { targets: [5], data: "PIN", className: '', visible: true, searchable: true, width: "3%" },
    ...
    { targets: [9], data: "FromDateTime", className: '', visible: true, searchable: true, width: "3%" },
    { targets: [10], data: "ToDateTime", className: '', visible: true, searchable: true, width: "3%" },
    { targets: [11], data: "Operation", className: '', visible: true, searchable: true, width: "10%" },
    ...
    { targets: [14], data: "Anaesthesia", className: '', visible: true, searchable: true, width: "10%" }
    ];
    return cols;
}
...
function ShowList(dfrom, dto) {
    var Url = baseURL + "MainListOTRequest";
    var param = {
        dfrom: dfrom,
        dto: dto
    };
