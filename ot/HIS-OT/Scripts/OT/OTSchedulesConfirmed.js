...
function InitSelect2() {
    //$('#selectOperationTheatre').select2({
    //    containerCssClass: "RequiredField",
    //    minimumInputLength: 0,
    //    allowClear: true,
    //    ajax: {
    //        quietMillis: 150,
    //        url: baseURL + 'Select2ReportOperationTheatre',
    //        dataType: 'jsonp',
    //        cache: false,
    ...
    //});
    //$('#select2ReportType').select2({
    //    data: [{ id: 0, text: 'Month Wise' }, { id: 1, text: 'Date Wise' }],
...
function DefaultValues() {
    ...
    c.SetDateTimePicker('#dtFrom', moment());
    c.SetDateTimePicker('#dtTo', moment());
    //c.SetSelect2('#select2ReportType', 0, 'Month Wise');
}
...
function View(deptid, date, MonthOrDate) {
    console.log('VIEW');
    Url = baseURL + "MainListOTScheduleConfirmedReport";
    param = {
        deptid: deptid,
        date: date,
...
function ShowListColumns() {
    //var cols = [
    //{ targets: [0], data: "OtId", className: '', visible: false, searchable: false, width: "0%" },
    //{ targets: [1], data: "OtId", className: '', visible: false, searchable: true, width: "1%" },
    //{ targets: [2], data: "RegistrationNo", className: '', visible: true, searchable: true, width: "6%" },
    //{ targets: [3], data: "PTName", className: '', visible: true, searchable: false, width: "6%" },
    //{ targets: [4], data: "BedName", className: '', visible: true, searchable: true, width: "2%" },
    //{ targets: [5], data: "OTName", className: '', visible: true, searchable: true, width: "3%" },
    //{ targets: [6], data: "Age", className: '', visible: true, searchable: true, width: "2%" },
    //{ targets: [7], data: "Sex", className: '', visible: true, searchable: true, width: "2%" },
    //{ targets: [8], data: "OR", className: '', visible: true, searchable: true, width: "2%" },
    //{ targets: [9], data: "OTStart", className: '', visible: true, searchable: true, width: "3%" },
    //{ targets: [10], data: "OTEnd", className: '', visible: true, searchable: true, width: "3%" },
    //{ targets: [11], data: "Surgery", className: '', visible: true, searchable: true, width: "10%" },
    ////{ targets: [12], data: "Surgeon", className: '', visible: true, searchable: true, width: "10%" },
    ////{ targets: [13], data: "Anaesthetist", className: '', visible: true, searchable: true, width: "10%" },
    //{ targets: [14], data: "Remarks", className: '', visible: true, searchable: true, width: "10%" }
    //];
    //return cols;
    var cols = [
 //{ data: "OtId", className: '', visible: false, searchable: false, width: "0%" },
 //{ data: "OtId", className: '', visible: false, searchable: true, width: "1%" },
 { data: "ctr", className: '', visible: true, searchable: true, width: "1%" },
{ data: "RegistrationNo", className: '', visible: true, searchable: true, width: "2%" },
{ data: "PTName", className: '', visible: true, searchable: false, width: "2%" },
{ data: "BedName", className: '', visible: true, searchable: true, width: "2%" },
{ data: "Age", className: '', visible: true, searchable: true, width: "1%" },
{ data: "Sex", className: '', visible: true, searchable: true, width: "1%" },
{ data: "OTName", className: '', visible: true, searchable: true, width: "2%" },
{ data: "OTStart", className: '', visible: true, searchable: true, width: "2%" },
{ data: "OTEnd", className: '', visible: true, searchable: true, width: "2%" },
{ data: "Surgery", className: '', visible: true, searchable: true, width: "2%" },
{ data: "Surgeon", className: '', visible: true, searchable: true, width: "2%" },
{ data: "Remarks", className: '', visible: true, searchable: true, width: "2%" }
    ];
    return cols;
}
...
function ShowList(dfrom, dto) {
    console.log('ShowList');
    var Url = baseURL + "MainListOTScheduleConfirmedReport";
    var param = {
        dfrom: dfrom,
        dto: dto
    };
