...
$(document).ready(function () {
    ...
    c.SetTitle("Department Surgery Mapping");
    c.DefaultSettings();
...
function View(Id, Name) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            c.SetSelect2('#select2Department', Id, Name);
...
function ShowSelectedColumns() {
    ...
    { targets: [1], data: "ctr", className: '', visible: true, searchable: true, width: "15%" },
    { targets: [2], data: "Code", className: '', visible: true, searchable: true, width: "25%" },
    { targets: [3], data: "Name", className: '', visible: true, searchable: true, width: "55%" }
    ];
    return cols;
}
...
function ShowSearchColumns() {
    ...
    var cols = [
    { targets: [0], data: "ID", className: '', visible: false, searchable: false, width: "0%" },
    { targets: [1], data: "Code", className: '', visible: true, searchable: true, width: "25%" },
    { targets: [2], data: "Name", className: '', visible: true, searchable: true, width: "75%" }
    ];
    return cols;
}
function ShowSearch() {
