...
$(document).ready(function () {
    ...
    c.SetTitle("Surgeries - Department Wise");
    c.DefaultSettings();
...
function InitButton() {
    ...
    $('#btnViewFilter').click(function () {
        var deptid = c.GetSelect2Id('#select2Department');
        var date = c.GetDateTimePickerDateTime('#dtDate');
        var MonthOrDate = c.GetSelect2Id('#select2ReportType');
        ShowList(deptid, date, MonthOrDate);
...
function InitSelect2() {
    $('#select2Department').select2({
        ...
        ajax: {
            quietMillis: 150,
            url: baseURL + 'Select2OTReportDepartment',
            dataType: 'jsonp',
            cache: false,
...
function DefaultValues() {
    ...
    c.SetDateTimePicker('#dtDate', moment());
...
function ShowListColumns() {
    var cols = [
    { targets: [0], data: "typeid", className: '', visible: false, searchable: false, width: "0%" },
    { targets: [1], data: "ctr", className: '', visible: true, searchable: true, width: "3%" },
    { targets: [2], data: "surgeon", className: '', visible: true, searchable: true, width: "15%" },
    { targets: [3], data: "surgeryid", className: '', visible: false, searchable: false, width: "0%" },
    { targets: [4], data: "Surgery", className: '', visible: true, searchable: true, width: "15%" },
    { targets: [5], data: "coun1", className: '', visible: true, searchable: true, width: "5%" }
    ];
    return cols;
}
...
function ShowList(deptid, date, MonthOrDate) {
    var Url = baseURL + "MainListSurgeriesDepartmentWise";
    var param = {
        deptid: deptid,
        date: date,
        MonthOrDate: MonthOrDate
