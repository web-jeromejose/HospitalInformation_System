    ...
    function () {
        ...
        i(scheduler.templates, {
            ...
            week_date: function (e, t) {
                return scheduler.templates.day_date(e) + " – " + scheduler.templates.day_date(scheduler.date.add(t, -1, "day"))
            },
    ...
    function () {
        ...
        time: {
            render: function (e) {
                ...
                return "<div style='height:30px;padding-top:0px;font-size:inherit;' class='dhx_section_time'>" + r + "<span style='font-weight:normal; font-size:10pt;'>  –  </span>" + r + "</div>"
            },
            set_value: function (e, t, s, i) {
                function a(e, t, s) {
