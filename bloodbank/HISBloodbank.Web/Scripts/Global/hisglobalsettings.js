...
*/
var appsname = ''; /* HISBLOODBANK  change with application folder (empty for local testing) */
var baseURL;
var hissystem = {
    appsserver: function () {
...
$(document).ready(function () {
    ...
    console.log('baseURL');
    console.log(baseURL);
    console.log('baseURLappsserver' + hissystem.appsserver(".his-base-url"));
    console.log('baseURLappsname' + hissystem.appsname(".his-base-url"));
