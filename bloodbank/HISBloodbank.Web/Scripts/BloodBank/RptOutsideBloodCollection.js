...
$(document).ready(function () {
    ...
    c.SetTitle("Donor Wise Blood Usage");
    c.DefaultSettings();
...
function GenerateReport() {
    ...
    var Id = c.GetSelect2Id('#select2OutsideHospital');
    var HospitalName = c.GetSelect2Text('#select2OutsideHospital');

    var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptOutsideBloodCollection/RptOutsideBloodCollection.aspx";
    var repsrc = dlink + "?UserId=" + UserId + "&From=" + From + "&To=" + To + "&Id=" + Id + "&HospitalName=" + HospitalName;
...
function InitSelect2() {
    $('#select2OutsideHospital').select2({
        containerCssClass: "RequiredField",
        minimumInputLength: 0,
        allowClear: true,
        ajax: {
            quietMillis: 150,
            url: baseURL + 'Select2RptIssueHospital',
            dataType: 'jsonp',
            cache: false,
