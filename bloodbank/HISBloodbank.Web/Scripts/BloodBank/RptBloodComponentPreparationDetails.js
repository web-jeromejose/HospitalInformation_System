...
$(document).ready(function () {
    ...
    c.SetTitle("Blood Component Preparation Details");
    c.DefaultSettings();
...
function GenerateReport() {
    ...
    var Id = c.GetSelect2Id('#select2BloodComponent');

    var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptBloodComponentPreparationDetails/RptBloodComponentPreparationDetails.aspx";
