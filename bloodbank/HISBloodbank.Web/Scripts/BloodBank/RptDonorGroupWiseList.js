...
function GenerateReport() {
    ...
    var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptDonorGroupWiseList/RptDonorGroupWiseList.aspx";
...
function InitSelect2() {
    $('#select2BloodGroup').select2({
        ...
        ajax: {
            quietMillis: 150,
            url: baseURL + 'Select2RptBloodGroup',
            dataType: 'jsonp',
            cache: false,
