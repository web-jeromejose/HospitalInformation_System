...
function GenerateReport() {
    ...
    var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptBloodUsage/RptBloodUsage.aspx";
    var repsrc = dlink + "?UserId=" + UserId + "&From=" + From;
