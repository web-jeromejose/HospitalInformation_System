...
$(document).ready(function () {
    ...
    c.SetTitle("Outside Blood Issue");
    c.DefaultSettings();
...
function GenerateReport() {
    ...
    var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptOutsideBloodIssue/RptOutsideBloodIssue.aspx";
