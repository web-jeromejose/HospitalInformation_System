...
function GenerateReport() {
    ...
    //var dlink = hissystem.appsserver() + hissystem.appsname() + "Areas/BloodBank/Reports/RptBloodReturn/RptBloodReturn.aspx";
    var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptBloodReturn/RptBloodReturn.aspx";
   // var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptBloodDonorScreening/RptBloodDonorScreening.aspx";
    var repsrc = dlink + "?UserId=" + UserId + "&From=" + From + "&To=" + To;
...
function InitSelect2() {
    $('#select2EmployeeFilter').select2({
        minimumInputLength: 0,
        allowClear: true,
        ajax: {
            quietMillis: 150,
            url: baseURL + 'Select2EmployeeAppConfigFilter',
            dataType: 'jsonp',
            cache: false,
    ...
    $('#select2LeaveTypeFilter').select2({
        minimumInputLength: 0,
        allowClear: true,
        ajax: {
            quietMillis: 150,
            url: baseURL + 'Select2HROnlineLeaveType',
            dataType: 'jsonp',
            cache: false,
            data: function (term, page) {
                return {
