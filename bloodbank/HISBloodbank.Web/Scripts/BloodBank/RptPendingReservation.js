...
$(document).ready(function () {
    ...
    c.SetTitle("Pending Reservation");
    c.DefaultSettings();
...
function GenerateReport() {
    ...
    var dlink = hissystem.appsserver() + hissystem.appsname() + "/Areas/BloodBank/Reports/RptPendingReservation/RptPendingReservation.aspx";
    var repsrc = dlink + "?UserId=" + UserId;
