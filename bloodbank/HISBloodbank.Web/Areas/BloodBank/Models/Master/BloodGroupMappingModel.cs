...
{
    public class BloodGroupMappingModel
    {
        public string ErrorMessage { get; set; }

        public List<MainListBloodGrouping> List()
        {
            DBHelper db = new DBHelper();
            db.param = new SqlParameter[] {
                new SqlParameter("@Id", -1)
            };
            DataTable dt = db.ExecuteSPAndReturnDataTable("BLOODBANK.MainListBloodGroupMapping");
            List<MainListBloodGrouping> list = new List<MainListBloodGrouping>();
            if (dt.Rows.Count > 0) list = dt.ToList<MainListBloodGrouping>();
            return list;

        }
        public List<MainListBloodGrouping> ShowSelected(int id)
        {
            DBHelper db = new DBHelper();
            db.param = new SqlParameter[] {
        ...
        public List<MasterBloodGroupMappingSelected> BloodGroupMappingSelected(int bloodgroop, int type, int componentid)
        {
            DBHelper db = new DBHelper();
            db.param = new SqlParameter[] {
                new SqlParameter("@bloodgroop", bloodgroop),
                new SqlParameter("@type", type),
                new SqlParameter("@componentid", componentid)
            };
            DataTable dt = db.ExecuteSPAndReturnDataTable("BLOODBANK.MasterBloodGroupMappingSelected");
            List<MasterBloodGroupMappingSelected> list = new List<MasterBloodGroupMappingSelected>();
            if (dt.Rows.Count > 0) list = dt.ToList<MasterBloodGroupMappingSelected>();
            return list;
        }

        public bool Save(List<BloodGroupMapping> entry)
        {
            try
            {
                DBHelper db = new DBHelper();
                db.param = new SqlParameter[] {
                    ...
                    new SqlParameter("@xmlBloodGroupMapping",entry.ListToXml("BloodGroupMapping"))
                };

                db.param[0].Direction = ParameterDirection.Output;
                db.ExecuteSP("BLOODBANK.MasterBloodGroupMappingSave");
    ...
    public class Select2BGMBloodGroupRepository
    {
        ...
        const string CACHE_KEY = "$Select2BGMBloodGroupRepository$";
        ...
        */
        ...
        public Select2BGMBloodGroupRepository()
        {
        ...
        public IQueryable<IdName> Fetch()
        {
            ...
            //};
            dt = db.ExecuteSPAndReturnDataTable("BLOODBANK.Select2BGMBloodGroup");
    ...
    public class Select2BGMComponentRepository
    {
        #region INSTRUCTION: Alter the cache key.

        // 1.   Naming convention for the class name is PascalCase.
        //      example: const string CACHE_KEY = "CacheKey";
        const string CACHE_KEY = "$Select2BGMComponentRepository$";
        ...
        */
        ...
        public Select2BGMComponentRepository()
        {
        ...
        //      example:
        //          private IQueryable<SurgeryDepartment> Generate()
        public IQueryable<IdName> Fetch(int IdType)
        {
            //Check cache first before regenerating data.
            if (this.PutOnSession && HttpContext.Current.Cache[CACHE_KEY] != null)
            {
            ...
            DBHelper db = new DBHelper();
            db.param = new SqlParameter[] {
                new SqlParameter("@Type",IdType)
            };
            dt = db.ExecuteSPAndReturnDataTable("BLOODBANK.Select2BGMComponent");
    ...
    public class MainListBloodGrouping
    {
    ...
    public class MasterBloodGroupMappingSelected : IdName
    {
        public int ctr { get; set; }
