...
namespace HIS_BloodBank.Areas.BloodBank.Models
{
    public class BloodGroupModel
    {
        ...
        public List<BloodGroup> List()
        {
            ...
            DataTable dt = db.ExecuteSPAndReturnDataTable("BLOODBANK.MainListBloodGroup");
            List<BloodGroup> list = new List<BloodGroup>();
            if (dt.Rows.Count > 0) list = dt.ToList<BloodGroup>();
            return list;

        }
        public List<BloodGroup> ShowSelected(int id)
        {
            DBHelper db = new DBHelper();
            db.param = new SqlParameter[] {
        ...
        public bool Save(BloodGroup entry)
        {
            try
            {
                List<BloodGroup> BloodGroup = new List<BloodGroup>();
                BloodGroup.Add(entry);

                DBHelper db = new DBHelper();
                db.param = new SqlParameter[] {
                    new SqlParameter("@ErrorMessage", SqlDbType.VarChar, 500),
                    new SqlParameter("@Action", entry.Action),
                    new SqlParameter("@xmlBloodGroup",BloodGroup.ListToXml("BloodGroup"))
                };

                db.param[0].Direction = ParameterDirection.Output;
                db.ExecuteSP("BLOODBANK.MasterBloodGroupSave");
    ...
    public class Select2BloodGroupDepartmentRepository
    {
        ...
        const string CACHE_KEY = "$Select2BloodGroupDepartmentRepository$";
        ...
        */
        ...
        public Select2BloodGroupDepartmentRepository()
        {
        ...
        public IQueryable<IdName> Fetch()
        {
            ...
            //};
            dt = db.ExecuteSPAndReturnDataTable("BLOODBANK.Select2BloodGroupDepartment");
