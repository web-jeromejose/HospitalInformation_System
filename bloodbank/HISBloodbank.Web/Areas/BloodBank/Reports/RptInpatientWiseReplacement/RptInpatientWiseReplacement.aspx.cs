...
{
    public partial class RptInpatientWiseReplacement : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string reportTitle = "Patient Wise Replacement Report from : " + dtFrom.ToString("dd-MMM-yyyy") + " to " + dtTo.ToString("dd-MMM-yyyy");
            ...
            DataTable dtDetails1 = DB.ExecuteSPAndReturnDataTable("BLOODBANK.RptInpatientWiseReplacementDetails1");
            ...
            ReportViewer2.Reset();
            ReportViewer2.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"\Areas\BloodBank/Reports/RptInpatientWiseReplacement/RptInpatientWiseReplacement.rdl";
