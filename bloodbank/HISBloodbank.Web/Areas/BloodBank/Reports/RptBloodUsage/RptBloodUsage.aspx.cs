...
{
    public partial class RptBloodUsage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string reportTitle = "Blood Usage Report for the Year: " + From;
            ...
            DataTable dtDetails1 = DB.ExecuteSPAndReturnDataTable("BLOODBANK.RptBloodUsageDetails1");
            ...
            ReportViewer2.Reset();
            ReportViewer2.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"\Areas\BloodBank/Reports/RptBloodUsage/RptBloodUsage.rdl";
