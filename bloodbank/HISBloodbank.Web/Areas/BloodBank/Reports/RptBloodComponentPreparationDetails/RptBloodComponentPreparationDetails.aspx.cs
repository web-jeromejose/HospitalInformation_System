...
{
    public partial class RptBloodComponentPreparationDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string reportTitle = "Blood Component Preparation Details from " + dtFrom.ToString("dd-MMM-yyyy") + " to " + dtTo.ToString("dd-MMM-yyyy");
            ...
            DataTable dtDetails1 = DB.ExecuteSPAndReturnDataTable("BLOODBANK.RptBloodComponentPreparationDetails1");
            ...
            ReportViewer2.Reset();
            ReportViewer2.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"\Areas\BloodBank/Reports/RptBloodComponentPreparationDetails/RptBloodComponentPreparationDetails.rdl";
