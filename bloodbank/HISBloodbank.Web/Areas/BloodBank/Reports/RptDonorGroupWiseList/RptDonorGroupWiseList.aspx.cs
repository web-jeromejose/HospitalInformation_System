...
{
    public partial class RptDonorGroupWiseList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dtDetails1 = DB.ExecuteSPAndReturnDataTable("BLOODBANK.RptDonorGroupWiseListDetails1");
            ...
            ReportViewer2.Reset();
            ReportViewer2.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"\Areas\BloodBank/Reports/RptDonorGroupWiseList/RptDonorGroupWiseList.rdl";
