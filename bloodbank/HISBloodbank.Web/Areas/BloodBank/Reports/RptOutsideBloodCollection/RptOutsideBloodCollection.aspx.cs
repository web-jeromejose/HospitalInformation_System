...
{
    public partial class RptOutsideBloodCollection : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            HospitalName = Request.QueryString["HospitalName"].ToString();
            ...
            string reportTitle = "Outside Blood Collection Report, for the period from : " + dtFrom.ToString("dd-MMM-yyyy") + " to " + dtTo.ToString("dd-MMM-yyyy");
            ...
            DataTable dtDetails1 = DB.ExecuteSPAndReturnDataTable("BLOODBANK.RptOutsideBloodCollectionDetails1");
            ...
            ReportViewer2.Reset();
            ReportViewer2.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"\Areas\BloodBank/Reports/RptOutsideBloodCollection/RptOutsideBloodCollection.rdl";
            ...
            ReportViewer2.LocalReport.SetParameters(new ReportParameter("aaaDescription01", "Hospital: " + HospitalName));
