...
{
    public partial class RptBloodReturn : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string reportTitle = "BLOOD RETURN REPORT from : " + dtFrom.ToString("dd-MMM-yyyy") + " to " + dtTo.ToString("dd-MMM-yyyy");
            ...
            DataTable dtDetails1 = DB.ExecuteSPAndReturnDataTable("BLOODBANK.RptBloodReturnDetails1");
            ...
            ReportViewer2.Reset();
            ReportViewer2.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"\Areas\BloodBank/Reports/RptBloodReturn/RptBloodReturn.rdl";
            ...
            ReportViewer2.LocalReport.SetParameters(new ReportParameter("aaaReportTitle", "BLOOD RETURN REPORT"));
            ReportViewer2.LocalReport.SetParameters(new ReportParameter("aaaDescription01", reportTitle));
