...
{
    public partial class RptPendingReservation : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //string reportTitle = "SERO POSITIVE UNITS for the period from : " + dtFrom.ToString("dd-MMM-yyyy") + " to " + dtTo.ToString("dd-MMM-yyyy");
            ...
            //    new SqlParameter("@To", To) 
            //};
            DataTable dtDetails1 = DB.ExecuteSPAndReturnDataTable("BLOODBANK.RptPendingReservationDetails1");
            ...
            ReportViewer2.Reset();
            ReportViewer2.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"\Areas\BloodBank/Reports/RptPendingReservation/RptPendingReservation.rdl";
            ...
            ReportViewer2.LocalReport.SetParameters(new ReportParameter("aaaReportTitle", "Pending Reservation Requests And Replacements Report"));
