...
/****** Object:  StoredProcedure [ARIPBILLING].[generate_breakup_invoice_npd]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[generate_main_invoice]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[generate_main_invoice_npd]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[generate_main_invoice_pd]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_account_list]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_bill_list_npd]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_billlist_npd_batch]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_discharge_patients]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_general_invoice_category]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_general_invoice_company]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_admitdates]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_patients]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_breakup]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_breakup_CST]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_breakup_RBMED]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_main]    Script Date: 02/09/2016 17:49:38 ******/
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_nonpack_admitdate]    Script Date: 02/09/2016 17:49:38 ******/
...
BEGIN
	...
	CREATE TABLE #tmp1( 
		...
		PRICE NUMERIC(18,2), QTY INT, DISC NUMERIC(18,2), DEDUC NUMERIC(18,2),
		GROSS NUMERIC(18,2), NET NUMERIC(18,2), MEDICALIDNUMBER VARCHAR(50),
	...
	WHILE (@COUNTER <= @RCOUNT)
		...
		BEGIN
				...
				SELECT PP.BillNo, PP.ServiceName, PP.Code, PP.Descript,
					   PP.Price, pp.Qty, pp.Disc, pp.Deduc,
					   ( PP.Price * PP.Qty ),
					   ( ( PP.Price * PP.Qty ) - PP.Disc - PP.Deduc ) ,
...
/****** Object:  StoredProcedure [ARIPBILLING].[generate_main_invoice]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[generate_main_invoice_npd]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	CREATE TABLE #tmp1(
		RECTYPE VARCHAR(50), RECEIPTNO VARCHAR(50), DEPDATE VARCHAR(50),
		BILLNO VARCHAR(50), DEPTNAME VARCHAR(250), AMOUNT NUMERIC(18,2), DISCOUNT NUMERIC(18,2),
		DEDUCTABLE NUMERIC(18,2), MEDICALIDNUMBER VARCHAR(50),
		INVOICENO VARCHAR(50), PIN VARCHAR(50), PTNAME VARCHAR(50), POLICYNO VARCHAR(25),
		ADMITDATE VARCHAR(50), ADMITTIME VARCHAR(20), DISDATE VARCHAR(50), DISTIME VARCHAR(20),
		COMPANY VARCHAR(250), GRADE VARCHAR(20), CADDR VARCHAR(250)
	)
	...
	BEGIN
		...
		INSERT INTO #tmp1(RECTYPE, RECEIPTNO, DEPDATE, BILLNO, DEPTNAME,
			...
			DISDATE, DISTIME, COMPANY, GRADE, CADDR
			 ...
			 SELECT A.RECTYPE, A.ReceiptNo, A.DepDate, A.BillNo, A.DEPTNAME, A.AMOUNT, A.DISCOUNT, A.DEDUCTABLE, 
...
/****** Object:  StoredProcedure [ARIPBILLING].[generate_main_invoice_pd]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_account_list]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_bill_list_npd]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_billlist_npd_batch]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_discharge_patients]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_general_invoice_category]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_general_invoice_company]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_admitdates]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_patients]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_breakup]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_breakup_CST]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_breakup_RBMED]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_GIP_report_main]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
...
/****** Object:  StoredProcedure [ARIPBILLING].[get_nonpack_admitdate]    Script Date: 02/09/2016 17:49:39 ******/
SET ANSI_NULLS ON
GO
